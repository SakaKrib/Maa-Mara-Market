...
export default function VendorPendingOrdersTable() {
  ...
  // 🧠 Data extraction
  const pendingItems = Array.isArray(data?.pending_items) ? data.pending_items : [];
  ...
  return (
    ...
    >
      ...
      >
        Pending Orders ({data?.total_pending_items || 0})
      </Typography>
