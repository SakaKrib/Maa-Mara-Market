    ...
    <section className="space-y-5 text-[#222] sm:space-y-6">
        ...
        <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="flex shrink-0 items-center gap-2">
            <Link
              ...
              className="inline-flex min-h-10 items-center justify-center rounded-full bg-primary px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-blue-500/30"
            >
              Add product
            </Link>
      ...
      <section aria-label="Vendor dashboard analytics">
        ...
        <div className="grid min-w-0 grid-cols-1 gap-4 sm:gap-5 xl:grid-cols-12">
          ...
          <article className={`${cardClass} xl:col-span-7`}>
            <BarVendor />
          </article>

          <article className={`${cardClass} xl:col-span-5`}>
            <Activities />
          </article>
        </div>
      </section>
