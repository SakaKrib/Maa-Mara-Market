              ...
              <div className="flex items-center justify-between gap-3 border-b border-border p-4">
                <div className="flex min-w-0 flex-1 flex-col items-center text-center">
                  <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-primary/10 text-primary">
                    <IonIcon icon={item.icon || walletFallback(item.provider)} className="text-xl" />
                  </div>
                ...
                <span className="absolute right-4 top-4 rounded-full bg-primary/10 px-2.5 py-1 text-[10px] font-bold text-primary">{item.secondaryValue}</span>
              </div>
              <div className="p-4">
