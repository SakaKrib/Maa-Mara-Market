  ...
  const submit = async (event) => {
    ...
    try {
      ...
      await api.post("/api/support/inbox/", {
        ...
        category: form.category === "other" ? (form.customIssue.trim() || "other") : form.category,
        ...
        <section className="rounded-2xl border border-border bg-card p-6 shadow-sm sm:p-8">
          <form onSubmit={submit} className="space-y-5">
            <div>
              ...
              <input id="support-email" type="email" required value={form.email} onChange={update("email")} autoComplete="email" placeholder="you@example.com"
            ...
            <div>
              ...
              <select id="support-category" value={form.category} onChange={update("category")}
                ...
                {SUPPORT_ISSUES.map(([value, label]) => <option key={value} value={value}>{label}</option>)}
              </select>
            </div>

            {form.category === "other" && (
              <div>
                <label htmlFor="support-custom-issue" className="text-sm font-semibold text-card-foreground">Custom issue</label>
                <input id="support-custom-issue" type="text" maxLength={120} value={form.customIssue} onChange={update("customIssue")}
            ...
            <div>
              ...
              <input id="support-subject" type="text" required maxLength={255} value={form.subject} onChange={update("subject")}
            ...
            <div>
              ...
              <textarea id="support-message" required rows={7} value={form.message} onChange={update("message")}
